...
package com.sohail.android_navigation
...
//        val flowStepNumber = arguments?.getInt("flowStepNumber") //This old-style code is not type-safe. It's better to use safe args.
